  ...
  return (
    <div className="footer-top__contacts footer-contacts">
      ...
      <div className="footer-contacts__inner">
        ...
        <div className="footer-contacts__item">
          <a className="footer-contacts__link" href="tel:+380508330131">+38 050 833 01 31</a>
        </div>
        <div className="footer-contacts__item">
          <a className="footer-contacts__link" href="tel:+380508330131">+38 050 833 01 31</a>
        </div>
        <div className="footer-contacts__item">
          <a className="footer-contacts__link" href="mailto:tehnotable@gmail.com">tehnotable@gmail.com</a>
        </div>
      </div>
    </div>
  )
